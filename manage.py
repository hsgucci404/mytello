...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if camera_type == "stereo":
        ...
        elif cfg.CAMERA_TYPE == "TELLO":
            from parts.camera import TelloCamera
            cam = TelloCamera(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH)
    ...
    elif cfg.DRIVE_TRAIN_TYPE == "TELLO":
        from parts.actuator import TelloController

        tello_control = TelloController()

        V.add(tello_control, inputs=['throttle', 'angle'] )
